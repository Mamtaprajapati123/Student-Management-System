...
public class insertresult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String js=jTextField3.getText();
        String java=jTextField4.getText();
        String css=jTextField5.getText();
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/srm","root","Mamta@2901");
             ...
             if(rs.next()){
                 st.executeUpdate("insert into result values('"+rollno+"','"+dsa+"','"+js+"','"+java+"','"+css+"','"+html+"')");
                 ...
                 JOptionPane.showMessageDialog(null, "RollNo Doesn't Exsits!");
             }
